...
import { useScroollPosition } from "@/hooks/useScroollPosition"
import { NavbarDesktopProps } from "./NavbarDesktopProps";
...
export function NavbarDesktop(props: NavbarDesktopProps){
      const {users} = props;
      const scrollPosition = useScroollPosition();

      return <div className={cn(
            "z-30 left-0 right-0 top-0 h-16 fixed w-full transition-all duration-300",scrollPosition > 20 ? "bg-black": "bg-transparent"
      )}>
