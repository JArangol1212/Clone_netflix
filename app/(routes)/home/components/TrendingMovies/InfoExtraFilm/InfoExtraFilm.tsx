...
import { ActionnButtonsFilm } from "@/components/shared/ActionsButtonsFilm";
import { ChaptersInfo } from "@/components/shared/Chapterinfo";
import { FilmeGenre } from "@/components/shared/FilmGenre";
            ...
            <div className="opacity-0 absolute top-0 transition-all duration-300 z-10
             ...
             group-hover:opacity-100">
                ...
                <div className="p-4 shadow-lg">
                  <ActionnButtonsFilm idFilm={movie.id}/>
